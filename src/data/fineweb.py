...
def get_fineweb_data(datasets_dir, hf_path, subset, local_folder, num_proc=40):
    FINEWEB_DATA_PATH = os.path.join(datasets_dir, local_folder, subset)
    ...
    return {
        "train": os.path.join(FINEWEB_DATA_PATH, "train.bin"),
        "val": os.path.join(FINEWEB_DATA_PATH, "val.bin"),
    }
